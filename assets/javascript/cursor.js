...
// <![CDATA[
const colour = '#FFFF00'; // in addition to "random" can be set to any valid colour eg "#FFFF00" or "red"
const sparkles = 50;
...
const tinyx = new Array();
const tinyy = new Array();
const tinyv = new Array();
